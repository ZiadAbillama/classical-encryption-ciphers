...
const HomePage = () => {
  ...
  const ProfileMenu = () => (
    <div className="absolute top-16 right-4 z-50 w-80">
      <div className={`${currentTheme.card} backdrop-blur-xl border ${currentTheme.cardBorder} rounded-2xl shadow-2xl overflow-hidden`}>
        <div className={`bg-gradient-to-r ${theme === 'dark' ? 'from-cyan-600 to-purple-700' : 'from-cyan-500 to-purple-600'} p-6`}>
        ...
        <div className="p-4 space-y-2">
          ...
          <div className={`border-t ${currentTheme.cardBorder} my-2`}></div>
        ...
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className={`${currentTheme.text} font-bold text-xl`}>CRYPTOLAB</h1>
            ...
            <div className="flex items-center space-x-3">
              ...
              <div className={`flex items-center space-x-2 px-4 py-2 ${theme === 'dark' ? 'bg-orange-500/20 border-orange-500/40' : 'bg-orange-100 border-orange-300'} border rounded-full backdrop-blur-xl`}>
                ...
                <span className={`${theme === 'dark' ? 'text-orange-400' : 'text-orange-700'} font-bold`}>{user.stats.combo}x</span>
              </div>
              <div className={`flex items-center space-x-2 px-4 py-2 ${theme === 'dark' ? 'bg-purple-500/20 border-purple-500/40' : 'bg-purple-100 border-purple-300'} border rounded-full backdrop-blur-xl`}>
                ...
                <span className={`${currentTheme.text} font-bold`}>Lv.{user.stats.level}</span>
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
          ...
          >
            ...
            <div className="relative flex flex-col items-center text-center">
              ...
              <p className={currentTheme.textMuted}>Complete challenges and earn rewards</p>
            </div>
          </button>
          ...
          >
            ...
            <div className="relative flex flex-col items-center text-center">
              ...
              <p className={currentTheme.textMuted}>Track your crypto journey</p>
            </div>
          </button>
        </div>
