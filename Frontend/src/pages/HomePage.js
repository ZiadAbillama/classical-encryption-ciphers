    ...
    <div className={`min-h-screen ${currentTheme.bg} relative overflow-hidden`}>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            {/* Right side: theme + stats + profile */}
            <div className="flex items-center space-x-3">
              <button
                onClick={() =>
              ...
              >
                ...
                <span
                  className={`${currentTheme.text} font-medium hidden md:block`}
                >
                  {user.name}
                </span>
              </button>
      ...
      <div className="relative max-w-7xl mx-auto px-4 py-16">
        <div className="text-center mb-16">
          ...
          >
            Unlock the secrets of classical cryptography through gamified
            learning
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
          ...
          >
            <div
              className={`absolute inset-0 ${
                theme === 'dark'
                  ? 'bg-gradient-to-br from-cyan-600/0 to-cyan-600/10'
                  : 'bg-gradient-to-br from-cyan-400/0 to-cyan-400/20'
            ...
            <div className="relative flex flex-col items-center text-center">
              <div
                ...
                } rounded-2xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform shadow-lg`}
              >
          ...
          >
            <div
              className={`absolute inset-0 ${
                theme === 'dark'
                  ? 'bg-gradient-to-br from-purple-600/0 to-purple-600/10'
                  : 'bg-gradient-to-br from-purple-400/0 to-purple-400/20'
              } rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity`}
            />
            <div className="relative flex flex-col items-center text-center">
              <div
          ...
          >
            <div
              className={`absolute inset-0 ${
                theme === 'dark'
                  ? 'bg-gradient-to-br from-green-600/0 to-green-600/10'
                  : 'bg-gradient-to-br from-green-400/0 to-green-400/20'
              } rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity`}
            />
            <div className="relative flex flex-col items-center text-center">
              <div
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div
            className={`backdrop-blur-xl ${currentTheme.card} border ${currentTheme.cardBorder} rounded-2xl p-6 ${currentTheme.cardHover} transition-all shadow-lg`}
          >
            <div
